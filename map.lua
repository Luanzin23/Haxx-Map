---------------------
--- LOCALIZACAO DE TODAS GARAGEM LOJINHA AMMU LOJA DE ROUPAS SALAO TATU EMPREGOS CONCE BEBIDAS E VANILLA
-------------------- APENAS POR COMANDO ------------------
local marcacoes = {
	...
	{ 639.68,14.73,86.54,60,29,"Haxx Police Departament",0.5 },
	...
	{ 133.11,-1462.49,29.36,226,2,"Emprego | Pizza",0.5 },
...
RegisterCommand("blips",function(source,args)
    ...
    if haxx then
        TriggerEvent("Notify","aviso","Adicionado as localizacoes em seu mapa",3000)
